                ...
                case TypeCode.Char:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.String:
                            output.Push(ch.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.SByte:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num1.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Byte:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num2.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Int16:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num3.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.UInt16:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num4.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Int32:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num5.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.UInt32:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num6.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Int64:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num7.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.UInt64:
                    ulong num8 = (ulong)right;
                    switch (typeCode2)
                    {
                        case TypeCode.Char:
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num8.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Single:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Double:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num9.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Double:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Double:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num10.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.Decimal:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Decimal:
                            ...
                            return;
                        case TypeCode.String:
                            output.Push(num11.ToString() + (string)right);
                            return;
                    }
                    break;
                case TypeCode.String:
                    ...
                    switch (typeCode2)
                    {
                        case TypeCode.Boolean:
                            output.Push(str + (bool)right);
                            return;
                        case TypeCode.Char:
                            output.Push(str + (char)right);
                            return;
                        case TypeCode.SByte:
                            output.Push(str + (sbyte)right);
                            return;
                        case TypeCode.Byte:
                            output.Push(str + (byte)right);
                            return;
                        case TypeCode.Int16:
                            output.Push(str + (short)right);
                            return;
                        case TypeCode.UInt16:
                            output.Push(str + (ushort)right);
                            return;
                        case TypeCode.Int32:
                            output.Push(str + (int)right);
                            return;
                        case TypeCode.UInt32:
                            output.Push(str + (uint)right);
                            return;
                        case TypeCode.Int64:
                            output.Push(str + (long)right);
                            return;
                        case TypeCode.UInt64:
                            output.Push(str + (ulong)right);
                            return;
                        case TypeCode.Single:
                            output.Push(str + (float)right);
                            return;
                        case TypeCode.Double:
                            output.Push(str + (double)right);
                            return;
                        case TypeCode.Decimal:
                            output.Push(str + (decimal)right);
                            return;
                        case TypeCode.DateTime:
                            output.Push(str + (DateTime)right);
                            return;
                        case TypeCode.String:
                            output.Push(str + (string)right);
                            return;
                    }
                    break;
            }
