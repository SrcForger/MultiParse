...
{
    public class MPInequality : MPOperator
    {
        public MPInequality()
        ...
        public override void Execute(Stack<object> output)
        {
            ...
            NotEquals(output, left, right);
        }

        public void NotEquals(Stack<object> output, object left, object right)
        {
            ...
            switch (typeCode1)
            {
                ...
                case TypeCode.Char:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.UInt32:
                            output.Push(ch != (int)(uint)right);
                            return;
                        case TypeCode.Int64:
                            output.Push(ch != (long)right);
                            return;
                        case TypeCode.UInt64:
                            output.Push(ch != (long)(ulong)right);
                            return;
                ...
                case TypeCode.Byte:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Int32:
                            ...
                            return;
                        case TypeCode.UInt32:
                            output.Push(num2 != (int)(uint)right);
                            return;
                        case TypeCode.Int64:
                            output.Push(num2 != (long)right);
                            return;
                        case TypeCode.UInt64:
                            output.Push(num2 != (long)(ulong)right);
                            return;
                        case TypeCode.Single:
                ...
                case TypeCode.UInt16:
                    ...
                    switch (typeCode2)
                    {
                        ...
                        case TypeCode.Int32:
                            ...
                            return;
                        case TypeCode.UInt32:
                            output.Push(num4 != (int)(uint)right);
                            return;
                        case TypeCode.Int64:
                            output.Push(num4 != (long)right);
                            return;
                        case TypeCode.UInt64:
                            output.Push(num4 != (long)(ulong)right);
                            return;
                        case TypeCode.Single:
                ...
                case TypeCode.UInt32:
                    ...
                    {
                        case TypeCode.Char:
                            output.Push((int)num6 != (char)right);
                            return;
                        case TypeCode.SByte:
                            output.Push(num6 != (sbyte)right);
                            return;
                        case TypeCode.Byte:
                            output.Push((int)num6 != (byte)right);
                            return;
                        case TypeCode.Int16:
                            output.Push(num6 != (short)right);
                            return;
                        case TypeCode.UInt16:
                            output.Push((int)num6 != (ushort)right);
                            return;
                        case TypeCode.Int32:
                            output.Push(num6 != (int)right);
                            return;
                        case TypeCode.UInt32:
                            output.Push((int)num6 != (int)(uint)right);
                            return;
                        case TypeCode.Int64:
                            output.Push(num6 != (long)right);
                            return;
                        case TypeCode.UInt64:
                            output.Push(num6 != (long)(ulong)right);
                            return;
                        case TypeCode.Single:
                ...
                case TypeCode.UInt64:
                    ...
                    {
                        case TypeCode.Char:
                            output.Push((long)num8 != (char)right);
                            return;
                        case TypeCode.Byte:
                            output.Push((long)num8 != (byte)right);
                            return;
                        case TypeCode.UInt16:
                            output.Push((long)num8 != (ushort)right);
                            return;
                        case TypeCode.UInt32:
                            output.Push((long)num8 != (uint)right);
                            return;
                        case TypeCode.UInt64:
                            output.Push((long)num8 != (long)(ulong)right);
                            return;
                        case TypeCode.Single:
