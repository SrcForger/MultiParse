...
{
    public class MPRelationalSmallerEqual : MPOperator
    {
        public MPRelationalSmallerEqual()
        ...
        public override void Execute(Stack<object> output)
        {
            ...
            RelationalSmallerEqual(output, left, right);
        }

        public void RelationalSmallerEqual(Stack<object> output, object left, object right)
        {
