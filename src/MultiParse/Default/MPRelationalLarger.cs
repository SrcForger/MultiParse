...
{
    public class MPRelationalLarger : MPOperator
    {
        public MPRelationalLarger()
        ...
        public override void Execute(Stack<object> output)
        {
            ...
            RelationalLarger(output, left, right);
        }

        public void RelationalLarger(Stack<object> output, object left, object right)
        {
